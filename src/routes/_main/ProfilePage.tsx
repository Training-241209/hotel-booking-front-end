    ...
    <div className="col-span-full row-start-2 row-end-13 grid text-[#022b60]">
      <div className="user__container flex flex-col gap-3 rounded">
        <div className="user__container__header relative grid grid-cols-12 items-center gap-3 rounded-md bg-white p-2 px-3 shadow-md">
          ...
          <div className="col-span-2 col-start-11 flex h-full flex-col items-center justify-center gap-3 sm:col-span-4 sm:col-start-10 md:col-span-3 md:col-start-10 xs:col-span-3 xs:col-start-10 xxs:hidden">
        ...
        <Popover>
          <PopoverTrigger>
            <EllipsisVertical className="absolute right-0 top-0 m-2 mt-5 hidden scale-150 xxs:flex text-white" />
          </PopoverTrigger>
